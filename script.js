const movieTitles = [ 
  ...
  'Business Proposal', 'True Beauty', 'My Name', 'Alchemy of Souls', 'Noragami', 'Fruits Basket', 'Mashle: Magic and Muscles', 'Love Alarm', 'Nevertheless', 'Kaguya-sama: Love is War', 'The Promised Neverland', 'Oshi no Ko', 'Angel Beats!', 'Steins;Gate', 'Hidden love', 'Flower of Evil', 'Itaewon Class', 'Extracurricular', 'Aquaman', 'Sweet revenge', 'Dating in the kitchen', 'Blue Lock', 'Kimetsu no Yaiba', 'Solo Leveling', 'Attack on Titan', 'Miraculous: Tales of Ladybug & Cat Noir', 'The Boss Baby', 'Inception', 'Interstellar', 'Wonder', 'Moana', 'Cloudy with a Chance of Meatballs', 'Secrets of Sulphur Springs', ' The Passion of the Christ (2004)', 'The Passion of the Christ', 'The Bible', 'Risen', 'God’s Not Dead', 'Soul Surfer', ' Heaven Is for Real', 'The Shack', 'That girl lay lay', 'Frozen','Alvin and the chipmunks', 'Spider-Man 3', 'The Amazing Spider-Man', 'The Amazing Spider-Man 2', 'Spider-Man: Homecoming', 'Spider-Man: Far From Home', 'Spider-Man: No Way Home', 'Spider-Man: Into the Spider-Verse', 'Spider-Man: Across the Spider-Verse ', 'Spider-Man: Beyond the Spider-Verse', 'The Lion King', 'Noah', 'Exodus: Gods and Kings', 'Son of God', 'Woodlawn',
];
